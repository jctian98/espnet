...
SPEECHLM_TASKS["text_to_audio"] = SpeechLMTaskTemplate(
    conditions=[("text", "text_bpe", "text")],
    targets=[("wav.scp", "codec_ssl", "kaldi_ark")],
)

SPEECHLM_TASKS["audio_to_text"] = SpeechLMTaskTemplate(
    conditions=[("wav.scp", "codec_ssl", "kaldi_ark")],
    targets=[("text", "text_bpe", "text")],
)

SPEECHLM_TASKS["continuous_audio_caption"] = SpeechLMTaskTemplate(
    conditions=[("wav.scp", "speech_ssl_encoder", "kaldi_ark")],
    targets=[("text", "text_bpe", "text")],
)
