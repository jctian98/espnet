...
class AbsTask(ABC):
    ...
    def get_parser(cls) -> config_argparse.ArgumentParser:
        ...
        group.add_argument(
            ...
            type=int,
            default=-1,
            help="The number of epoch to run in this launch, if > 0",
        )
        group.add_argument(
            "--patience",
            type=int_or_none,
    ...
    def main(
        ...
        if not args.distributed or not args.multiprocessing_distributed:
            ...
            world_size = get_num_nodes(args.dist_world_size, args.dist_launcher)
            assert world_size % args.ngpu  == 0
            num_nodes = world_size // args.ngpu
